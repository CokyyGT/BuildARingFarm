...
-- Debug indicator (change main color saat drag)
...
UIS.InputBegan:Connect(function(inp, gameProc)
    ...
    if inp.UserInputType == Enum.UserInputType.MouseButton1 or inp.UserInputType == Enum.UserInputType.Touch then
        ...
        main.BackgroundColor3 = Color3.fromRGB(255, 200, 0)  -- Change to yellow saat drag
    end
end)
...
UIS.InputEnded:Connect(function(inp, gameProc)
    if inp.UserInputType == Enum.UserInputType.MouseButton1 or inp.UserInputType == Enum.UserInputType.Touch then
        dragging = false
        main.BackgroundColor3 = originalColor  -- Kembali normal
    end
end)
